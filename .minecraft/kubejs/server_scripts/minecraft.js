ServerEvents.recipes((event) => {
    ...
    gtr.lightning_processor("gtocore:ghast_tear")
    ...
    gtr.lightning_processor("gtocore:skeleton_skull")
    ...
    gtr.lightning_processor("gtocore:zombie_head")
    ...
    gtr.lightning_processor("gtocore:creeper_head")
    ...
    gtr.lightning_processor("gtocore:piglin_head")
    ...
    gtr.lightning_processor("gtocore:enderman_head")
    ...
    gtr.lightning_processor("gtocore:wither_skeleton_skull")
    ...
    gtr.lightning_processor("gtocore:nether_star_dust")
    ...
    gtr.lightning_processor("gtocore:nether_star")
    ...
    gtr.lightning_processor("gtocore:reinforced_deepslate")
    ...
    gtr.lightning_processor("gtocore:echobone")
    ...
    gtr.lightning_processor("gtocore:glowstone_dust")
    ...
    gtr.lightning_processor("gtocore:prismarine")
    ...
    gtr.lightning_processor("gtocore:dragon_egg")
    ...
    gtr.lightning_processor("gtocore:crying_obsidian")
    ...
    gtr.lightning_processor("gtocore:netherite_scrap")
