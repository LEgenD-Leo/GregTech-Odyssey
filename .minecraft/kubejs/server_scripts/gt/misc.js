ServerEvents.recipes(event => {
    ...
    gtr.lightning_processor("gtocore:naquadah_contain_rare_earth_fluoride_dust")
    ...
    gtr.lightning_processor("gtocore:adamantine_compounds_dust_a")
    ...
    gtr.lightning_processor("gtocore:nether_air")
    ...
    gtr.lightning_processor("gtocore:ender_air")
    ...
    gtr.lightning_processor("gtocore:thaumium_dust")
    ...
    gtr.lightning_processor("gtocore:nitric_oxide")
    ...
    gtr.aggregation_device("gtocore:chaotic_core")
        .notConsumable("gtocore:dragon_stabilizer_core")
        .itemInputs("gtceu:draconium_nanoswarm", "gtceu:opv_field_generator", "gtocore:chaos_shard", "gtceu:legendarium_block", "gtocore:awakened_core", "gtocore:max_field_generator", "gtocore:unstable_star", "gtceu:awakened_draconium_block")
