ServerEvents.recipes(event => {
    ...
    gtr.assembler_module("gtocore:microwormhole_generator")
        .itemInputs("2x gtceu:zpm_emitter", "2x gtceu:enriched_naquadah_trinium_europium_duranide_single_wire", "2x gtceu:neutronium_plate", "gtceu:zpm_field_generator", "gtocore:contained_kerr_singularity", "gtocore:void_matter", "gtceu:enderium_nanoswarm", "2x gtceu:celestial_tungsten_plate")
    ...
    gtr.assembler_module("gtocore:nuclear_clock")
        .itemInputs("2x gtceu:uiv_sensor", "2x gtocore:ultrashort_pulse_laser", "2x gtceu:neutronium_plate", "gtocore:scintillator", "gtocore:bose_einstein_cooling_container", "gtceu:iron_nanoswarm", "gtceu:uv_naquadria_battery", "2x gtceu:double_rhodium_plate")
    ...
    gtr.assembler("gtocore:strengthen_the_base_block")
        .itemInputs("1x gtceu:titanium_frame")
    ...
    gtr.assembler("gtocore:pbi_radiation_resistant_mechanical_enclosure")
        .itemInputs("1x gtceu:tungsten_frame")
    ...
    gtr.assembler("gtocore:reinforced_epoxy_resin_mechanical_housing")
        .itemInputs("1x gtceu:invar_frame")
    ...
    gtr.assembler("gtocore:pps_corrosion_resistant_mechanical_housing")
        .itemInputs("1x gtceu:polytetrafluoroethylene_frame")
    ...
    gtr.assembler("gtocore:mc_nylon_tensile_mechanical_shell")
        .itemInputs("1x gtceu:blue_steel_frame")
    ...
    gtr.assembler("gtocore:graviton_field_constraint_casing")
        .itemInputs("gtceu:draconium_frame", "gtocore:annihilation_constrainer", "gtceu:neutronium_nanoswarm", "gtceu:celestial_tungsten_gear", "4x gtceu:double_adamantium_plate")
    ...
    gtr.assembler("gtocore:protonated_fullerene_sieving_matrix")
        ...
        .itemOutputs("1x gtocore:protonated_fullerene_sieving_matrix")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(350)
    ...
    gtr.assembler("gtocore:awakened_draconium_casing")
        .itemInputs("1x gtceu:hexaphasecopper_frame")
        .itemInputs("6x gtceu:awakened_draconium_plate")
        .itemOutputs("1x gtocore:awakened_draconium_casing")
    ...
    gtr.assembler("gtocore:pressure_containment_casing")
        ...
        .itemOutputs("1x gtocore:pressure_containment_casing")
        .inputFluids("gtceu:stainless_steel 1152")
        .EUt(120)
        .duration(100)
    ...
    gtr.assembler("gtocore:activated_carbon_filter_mesh")
        ...
        .itemOutputs("1x gtocore:activated_carbon_filter_mesh")
        .EUt(120)
        .duration(200)
    ...
    gtr.assembler("gtocore:chemical_grade_glass")
        ...
        .itemOutputs("1x gtocore:chemical_grade_glass")
    ...
    gtr.assembler("gtocore:water_purification_plant")
        ...
        .itemInputs("1x gtceu:ev_robot_arm")
        ...
        .itemOutputs("1x gtocore:water_purification_plant")
        .EUt(480)
        .duration(200)

    gtr.assembler("gtocore:sterile_water_plant_casing")
        .itemInputs("1x gtceu:tungsten_steel_frame")
        .itemInputs("1x gtceu:mv_electric_motor")
        .itemInputs("8x gtceu:polyvinyl_chloride_foil")
        .itemInputs("2x gtceu:double_desh_plate")
        .itemOutputs("1x gtocore:sterile_water_plant_casing")
        .EUt(120)
        .duration(200)

    gtr.assembler("gtocore:reinforced_sterile_water_plant_casing")
        .itemInputs("1x gtocore:sterile_water_plant_casing")
        .itemInputs("16x gtceu:potin_bolt")
        .itemOutputs("1x gtocore:reinforced_sterile_water_plant_casing")
        .inputFluids("gtceu:concrete 1152")
        .EUt(30)
        .duration(200)
    ...
    gtr.assembler("gtocore:clarifier_purification_unit")
        ...
        .itemOutputs("1x gtocore:clarifier_purification_unit")
        .EUt(480)
        .duration(400)

    gtr.assembler("gtocore:virtual_item_provider")
        .itemInputs("1x gtceu:programmed_circuit")
        .itemInputs("1x ae2:quartz_vibrant_glass")
        .itemInputs("8x gtceu:polyvinyl_chloride_foil")
        .itemOutputs("1x gtocore:virtual_item_provider")
        .EUt(30)
        .duration(200)

    gtr.assembler("gtocore:virtual_item_provider_cell")
        .itemInputs("1x ae2:item_storage_cell_1k")
        .itemInputs("1x gtocore:virtual_item_provider")
        .itemInputs("2x gtceu:mv_conveyor_module")
        .itemOutputs("1x gtocore:virtual_item_provider_cell")
