ServerEvents.recipes(event => {
    ...
    gtr.precision_assembler("gtocore:luv_compressed_fusion_reactor")
        ...
        .itemOutputs("gtocore:luv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtocore:zpm_compressed_fusion_reactor")
        ...
        .itemOutputs("gtocore:zpm_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtocore:uv_compressed_fusion_reactor")
        ...
        .itemOutputs("gtocore:uv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtocore:uhv_compressed_fusion_reactor")
        ...
        .itemOutputs("gtocore:uhv_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)

    gtr.precision_assembler("gtocore:uev_compressed_fusion_reactor")
        ...
        .itemOutputs("gtocore:uev_compressed_fusion_reactor")
        .EUt(GTValues.VA[GTValues.UEV])
        .duration(400)
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    gtr.assembler("gtocore:chemical_distort")
        .itemInputs("gtocore:chemical_plant", "16x gtceu:carbon_nanoswarm", "8x gtceu:uv_electric_pump", "8x gtceu:uv_emitter", "8x #gtceu:circuits/uv", "8x gtceu:naquadria_plate")
        .inputFluids("gtceu:soldering_alloy 1296")
        .itemOutputs("gtocore:chemical_distort")
        .EUt(524288)
        .duration(400)
