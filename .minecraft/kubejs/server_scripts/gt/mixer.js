ServerEvents.recipes(event => {
    ...
    gtr.mixer("gtocore:actinium_trinium_hydroxides_dust")
        .itemInputs("58x gtceu:actinium_trinium_hydroxides_dust", "6x gtceu:radium_dust", "1x gtocore:protonated_fullerene_sieving_matrix")
        .inputFluids("minecraft:water 2000")
        .itemOutputs("1x gtocore:saturated_fullerene_sieving_matrix")
